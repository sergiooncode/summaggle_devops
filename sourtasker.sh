...
PID_FILE=/var/run/summaggle/sourtasker.pid
STD_LOG=/var/log/sourtasker_stdout.log
ERR_LOG=/var/log/sourtasker_stderr.log
touch $STD_LOG
touch $ERR_LOG
...
make start-tasks 2>>$ERR_LOG >> $STD_LOG &
echo $! > /var/run/summaggle/sourtasker.pid
